  ...
  const authProvider: AuthBindings = {
    login: async ({ email, password }) => {
      try {
          ...
          localStorage.setItem("wealthManagerId", user._id); // to store  locally,the  id of wealth manager 
          localStorage.setItem("wealthManagerName", user.fullName); // to store  locally,the  id of wealth manager 
          console.log('Wealth Manager Name from login:', user.fullName); // Debugging statement
          console.log('Wealth Manager ID:', user._id); // Debugging statement
